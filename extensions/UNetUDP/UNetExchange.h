...
namespace uniset
{
    ...
    По умолчанию \b packsendpause=5 миллисекунд.
     ...
     \section pgUNetUDP_ControlSensor Управление обменом
     ...
     \note В случае необходимости управления и приёмом передачей одновременно, можно просто указать один и тот же управляющий датчик.
    */
    // -----------------------------------------------------------------------------
