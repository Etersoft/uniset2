/*
 * Lightweight helper around native uniset.modbus bindings.
 * Provides convenient object-based API similar to mbtcptester/mbtester tools.
...
(function(global) {
    ...
    function buildFactory(target) {
        ...
        function toUInt(value, where, def) {
            ...
            return num >= 0 ? Math.floor(num) : (() => { throw new RangeError(where + ": must be >= 0"); })();
        }
        ...
        return function createModbusClient(unisetObj) {
            ...
            return {
                ...
                write0F: function(opts) {
                    ...
                    const start = toUInt(o.reg, "write0F.reg");
                ...
                write10: function(opts) {
                    ...
                    const start = toUInt(o.reg, "write10.reg");
    ...
    global.__uniset_modbus_client_factory = factory;

    if (typeof module !== "undefined" && module.exports)
        module.exports = { createModbusClient: factory };

    if (!global.uniset_createModbusClient)
        global.uniset_createModbusClient = factory;
