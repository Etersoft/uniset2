...
VCS: https://github.com/Etersoft/uniset2
...
%if_enabled opcua
BuildRequires: libopen62541-devel >= 1.4.14-alt1 libopen62541pp-devel >= 0.20.0-alt1
%endif
...
* Sun Mar 01 2026 Pavel Vainerman <pv@altlinux.ru> 2.44.4-alt1
...
- (smviewer): print ACL
- (uniset): supported "run lock"
- (SM): --sm-ignore-acl-errors

* Tue Nov 04 2025 Pavel Vainerman <pv@altlinux.ru> 2.41.1-alt1
- (jscript): mini http server
- (iocontroller): access control
...
- (logdb): supported logcontrol API (set,reset,get)
- (logdb): tests refactoring, added websocket tests
...
* Mon Oct 07 2024 Pavel Vainerman <pv@altlinux.ru> 2.36.2-alt2
- fixed version
...
* Sat Apr 27 2024 Pavel Vainerman <pv@altlinux.ru> 2.35.2-alt1
- (opcua): updated for open62541pp 0.13.0

* Mon Apr 08 2024 Pavel Vainerman <pv@altlinux.ru> 2.35.1-alt1
- (opcua): supported subscription, thresholds
...
* Fri Nov 04 2022 Pavel Vainerman <pv@altlinux.ru> 2.24.2-alt1
- (modbus): fixed "rtu optimization"

* Mon Oct 24 2022 Pavel Vainerman <pv@altlinux.ru> 2.24.1-alt1
...
* Sun May 15 2022 Pavel Vainerman <pv@altlinux.ru> 2.21.1-alt1
